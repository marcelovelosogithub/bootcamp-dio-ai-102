...
# Sidebar com o menu
selected_page = st.sidebar.radio("Menu", list(menu_options.keys()), format_func=lambda x: f"{x} {menu_options[x]}")
                    ...
                    if card_info:
                        ...
                        if validation_result["is_valid"]:
                            ...
                            if existing_card:
                                ...
                                card_info["is_valid"] = validation_result["is_valid"]  # Converter para string para o banco de dados
    ...
    if st.button("Executar Query"):
        try:
            ...
            if results:
                ...
                st.download_button("Download CSV", csv, file_name="credit_cards.csv", mime="text/csv")
            else:
